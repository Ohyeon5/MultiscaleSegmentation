...
class Loader(object):
    ...
    def import_data(dir_original, dir_segmented, init_size=None, one_hot=True):
        ...
        paths_original, paths_segmented, filenames = Loader.generate_paths(dir_original, dir_segmented)
        ...
        return DataSet(images_original, images_segmented, palette,
                       augmenter=ia.ImageAugmenter(size=init_size, class_count=len(DataSet.CATEGORY)),filenames=filenames)
    ...
    def generate_paths(dir_original, dir_segmented):
        ...
        return paths_original, paths_segmented, filenames
...
class DataSet(object):
    ...
    def __init__(self, images_original, images_segmented, image_palette, augmenter=None, filenames=None):
    ...
    def __add__(self, other):
        ...
        filenames_original = np.concatenate([self._filenames, other._filenames])
        return DataSet(images_original, images_segmented, self._image_palette, self._augmenter,filenames_original)
    ...
    def perm(self, start, end):
        ...
        return DataSet(self._images_original[start:end], self._images_segmented[start:end], self._image_palette, self._augmenter, self._filenames[start:end])
    ...
    def __call__(self, batch_size=20, shuffle=True, augment=True):
        ...
        or call each test set to be saved to be evaluated
        Args:
